      ...
      <div className="container-career">
        ...
        <div className="ourteam-top">
          ...
          <p className="ourteam-description">
            Our company is a young and dynamic company with a start-up
            environment that is always looking for qualified talent to join the
            team. Work closely with the country's most talented product
            developers and engineers on exciting new opportunities from our
